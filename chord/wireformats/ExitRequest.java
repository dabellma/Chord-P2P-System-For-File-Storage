...
public class ExitRequest implements Event {
    ...
    public ExitRequest(String ipAddress, int portNumber) {
        this.messageType = Protocol.EXIT_REQUEST.getValue();
        this.ipAddress = ipAddress;
        this.portNumber = portNumber;
    }

    public ExitRequest(byte[] incomingByteArray) throws IOException {
    ...
    public byte[] getbytes() throws IOException {
        ...
        dataOutputStream.writeInt(Protocol.EXIT_REQUEST.getValue());
