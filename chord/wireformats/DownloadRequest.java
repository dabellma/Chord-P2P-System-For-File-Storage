...
public class DownloadRequest implements Event {
    ...
    public DownloadRequest(String ipAddress, int portNumber, String file, int lengthPathTaken, List<String> pathTaken) {
        this.messageType = Protocol.DOWNLOAD_REQUEST.getValue();
    ...
    public DownloadRequest(byte[] incomingByteArray) throws IOException {
    ...
    public byte[] getbytes() throws IOException {
        ...
        dataOutputStream.writeInt(Protocol.DOWNLOAD_REQUEST.getValue());
