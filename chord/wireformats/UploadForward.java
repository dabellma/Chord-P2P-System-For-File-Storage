...
public class UploadForward implements Event {
    ...
    public UploadForward(String fileName,  int fileLength, byte[] file) {
        this.messageType = Protocol.UPLOAD_FORWARD.getValue();
        this.fileName = fileName;
        this.fileLength = fileLength;
        this.file = file;
    }

    public UploadForward(byte[] incomingByteArray) throws IOException {
    ...
    public byte[] getbytes() throws IOException {
        ...
        dataOutputStream.writeInt(Protocol.UPLOAD_FORWARD.getValue());
